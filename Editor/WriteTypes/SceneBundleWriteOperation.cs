...
{
    [Serializable]
    public struct SceneBundleWriteOperation : IWriteOperation
    {
        ...
        {
            return HashingMethods.CalculateMD5Hash(Command, UsageSet.GetHash128(), ReferenceMap.GetHash128(), Scene, ProcessedScene, PreloadInfo, Info);
        }
    }
}
